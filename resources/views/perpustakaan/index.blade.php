            ...
            <tr class="hover:bg-slate-50 transition-colors">
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center justify-end gap-2">
                        ...
                        <button type="button" onclick="confirmDeleteBuku('{{ $item->id_buku }}', '{{ addslashes($item->judul_buku) }}')" class="p-2 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors">

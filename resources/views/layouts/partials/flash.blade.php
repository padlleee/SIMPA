{{-- ============================================================
     Partial: layouts/partials/flash.blade.php
     Reusable Flash Message Alerts (success & error)
...
@if(session('warning'))
<div class="fade-in mb-6 bg-amber-50 border border-amber-200 text-amber-800 rounded-xl px-5 py-4 flex items-center gap-3">
    <svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        <path fill-rule="evenodd"

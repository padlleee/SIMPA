        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-xl font-bold text-slate-800">Yayasan Amaliya Subang</span>
                </div>
                <p class="text-slate-600 text-sm leading-relaxed mb-6">
                    Sistem Informasi Manajemen Panti Asuhan (SIMPA) didedikasikan untuk mengelola data operasional dan memberikan transparansi informasi bagi publik dan para donatur tercinta.
                </p>
                <div class="flex gap-4">
                    <a href="https://instagram.com/amaliya_subang" target="_blank" class="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-slate-800 hover:text-white transition-colors">
                    ...
                    <a href="https://facebook.com/YayasanAmaliyaSubang" target="_blank" class="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-slate-800 hover:text-white transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
                    </a>
                    <a href="https://youtube.com/YayasanAmaliyaSubang" target="_blank" class="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-slate-800 hover:text-white transition-colors">
            ...
            <!-- KONTAK -->
            <div>
                <h3 class="text-sm font-bold text-slate-800 uppercase tracking-wider mb-6">Hubungi Kami</h3>
                <ul class="space-y-4">
                    <li class="flex items-start gap-4 text-slate-600">
                        ...
                        <span class="text-sm">+62 811-9918-090</span>
                    </li>
                    <li class="flex items-start gap-4 text-slate-600">
                        ...
                        <span class="text-sm">info.amaliyasubang@gmail.com</span>
                    </li>
                    <li class="flex items-start gap-4 text-slate-600">

    ...
    <form action="{{ route('pengeluaran.store') }}" method="POST" class="space-y-5">
        ...
        <div class="grid md:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input type="text" name="kategori_biaya" value="{{ old('kategori_biaya') }}" placeholder="cth: Makan, Kesehatan"
                       class="w-full border border-slate-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-slate-800 @error('kategori_biaya') border-red-400 @enderror">

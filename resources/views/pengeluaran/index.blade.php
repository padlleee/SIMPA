    ...
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-slate-100">
            ...
            <tr class="hover:bg-slate-50 transition-colors">
                ...
                <td class="px-4 py-4">
                    <span class="bg-slate-100 text-slate-600 text-xs font-medium px-2.5 py-1 rounded-full">{{ $item->kategori }}</span>
                </td>
                <td class="px-4 py-4 text-slate-500 text-xs">{{ $item->keterangan ?? '-' }}</td>
                <td class="px-4 py-4 text-right font-bold text-slate-800">Rp {{ number_format($item->jumlah, 0, ',', '.') }}</td>
                <td class="px-6 py-4">

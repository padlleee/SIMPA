...
<body>
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <p class="info-text">
                Sistem menerima permintaan untuk mereset password akun Anda di SIMPA. 
            ...
            <div class="warning-box" style="margin-top: 30px;">
                <p>Jika Anda tidak pernah meminta reset password, Anda dapat mengabaikan pesan ini. Password Anda akan tetap aman dan tidak akan berubah.</p>
            </div>
            
            <p style="font-size: 13px; color: #64748b; margin-top: 20px; word-break: break-all;">
                Atau salin dan tempel URL berikut ke browser Anda:<br>
                <a href="{{ $data['reset_url'] }}" style="color: #2563eb;">{{ $data['reset_url'] }}</a>
            </p>
        </div>
        <div class="footer">
